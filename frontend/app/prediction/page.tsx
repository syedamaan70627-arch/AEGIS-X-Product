  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Onset-aware next-step failure prediction over controlled degradation trajectories."
        badge={<StatusBadge status={predCap?.status || "NOT_AVAILABLE"} />}
      />
        ...
        <div className="space-y-4">
          <div className="p-6 bg-slate-900 border border-slate-800 rounded-xl space-y-3">
            ...
            <p className="text-xs text-slate-300">
              {predCap?.reason || "Failure prediction requires pre-fitted degradation trajectory models."}
            </p>
